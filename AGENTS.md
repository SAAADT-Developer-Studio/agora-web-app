...
- **Light theme direction:** Cool editorial paper — soft blue-slate page atmosphere, crisp white cards with clearer borders and `shadow-vidik` elevation, inkier text. Keep the black header and electric-blue focus ring. Do not flatten everything to pure white-on-white.
