  ...
  return (
    <div className="mx-auto max-w-5xl px-1 py-6 sm:px-4 md:px-6 md:py-8">
      <div className="mb-10">
        ...
        <h1 className="text-surface-text mb-4 text-4xl font-bold tracking-tight">
          Politika zasebnosti
        </h1>
        <p className="text-surface-text/70 max-w-2xl leading-relaxed">
          Vaša zasebnost je za nas pomembna. Spodaj je razloženo, kako zbiramo,
          uporabljamo in varujemo vaše podatke.
        </p>
      </div>

      <div className="space-y-4">
        <div className="border-primary/10 bg-primary/5 rounded-xl border p-4">
          <h2 className="text-surface-text mb-3 text-2xl font-bold">
            Katere podatke obdelujemo
          </h2>
          <p className="text-surface-text/70 leading-relaxed">
        ...
        <section className="border-primary/10 bg-card rounded-2xl border p-4 shadow-sm transition-shadow hover:shadow-md">
          <div className="mb-4 flex items-center gap-3">
            <div className="bg-primary/10 flex h-10 w-10 items-center justify-center rounded-xl">
              <svg
                className="text-surface-text h-6 w-6"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <h2 className="text-surface-text text-xl font-bold">
              Tehnični podatki
            </h2>
          </div>
          <ul className="space-y-3">
            {[
              ...
              <li key={index} className="flex items-start gap-3">
                ...
                <span className="text-surface-text/80 leading-relaxed">
                  {item}
                </span>
              </li>
            ))}
        ...
        <section className="border-primary/10 bg-card rounded-2xl border p-4 shadow-sm transition-shadow hover:shadow-md">
          <div className="mb-4 flex items-center gap-3">
            ...
            <h2 className="text-surface-text text-xl font-bold">Nastavitve</h2>
          </div>
          <ul className="space-y-3">
        ...
        <section className="border-primary/10 bg-card rounded-2xl border p-4 shadow-sm transition-shadow hover:shadow-md">
          <div className="mb-4 flex items-center gap-3">
            ...
            <div>
              ...
              <span className="bg-primary/10 text-surface-text mt-1 inline-block rounded-full px-2.5 py-0.5 text-xs font-semibold">
                Nujno
              </span>
            </div>
          </div>
