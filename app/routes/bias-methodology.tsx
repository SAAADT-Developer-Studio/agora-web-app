  ...
  return (
    <div className="mx-auto max-w-5xl px-1 py-6 sm:px-4 md:px-6 md:py-8">
      <div className="text mb-10">
        ...
        <h1 className="text-surface-text mb-4 text-4xl font-bold tracking-tight md:text-4xl">
          Metodologija
        </h1>
        <p className="text-surface-text/70 max-w-3xl leading-normal">
          Ocenjujemo politično pristranskost slovenskih medijskih hiš na podlagi
          znanstvenih raziskav in analize lastništva.
        </p>
      </div>
      ...
      <section className="mb-10">
        <h2 className="text-surface-text mb-4 text-2xl font-bold">
          Kako Določamo Ocene
        </h2>
        ...
        <div className="space-y-4">
          <div className="rounded-lg">
            <div className="mb-3 flex items-center gap-2">
              <BookOpen className="text-surface-text h-5 w-5" />
              <h3 className="text-surface-text text-lg font-bold">
                Znanstvene raziskave
              </h3>
            </div>
            <p className="text-surface-text/70 mb-3 text-sm leading-normal">
            ...
            <div className="space-y-3">
              <a
                ...
                className="border-primary/10 hover:border-primary/30 group block rounded border p-3 transition-all duration-200 hover:shadow-md"
                aria-label="Odpri raziskavo: Analiza pristranskosti v slovenskih medijih"
              >
                <div className="mb-1 flex items-start justify-between gap-2">
                  <h4 className="text-surface-text group-hover:text-surface-text/90 text-sm font-semibold transition-colors">
                    Analiza pristranskosti v slovenskih medijih
                  </h4>
                  <ExternalLink className="text-surface-text h-4 w-4 flex-shrink-0 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
                </div>
                <p className="text-surface-text/60 mb-1 text-xs">
                  Caporusso et al. (2024)
                </p>
                <p className="text-surface-text/70 text-xs leading-normal">
                  Computational raziskava kombinira korpus novic z anketami o
                  medijski potrošnji in politični usmeritvi bralcev. Gradnja
                  klasifikatorja politične orientacije na podlagi medijskih hiš.
                </p>
              </a>
        ...
        {BIAS_RATINGS.map((rating) => (
          <div key={rating.label} className="">
            <div className="flex items-end gap-3">
              <div
                className={cn(
                  "mb-2 size-8 self-start rounded-sm",
                  rating.color,
                )}
              />
            ...
            <p className="text-surface-text/60 text-xs">{rating.description}</p>
          </div>
        ))}
      </div>
    </section>
