...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn("text-surface-text/70 text-sm", className)}
      {...props}
    />
  );
}
