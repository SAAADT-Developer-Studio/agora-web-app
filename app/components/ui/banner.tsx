...
export default function Banner(props: Readonly<BannerProps>) {
  return (
    <div className="bg-foreground border-vidikdarkgray/20 flex h-[170px] flex-col items-end justify-between rounded-lg border-1 p-4 sm:col-span-full dark:border-0">
