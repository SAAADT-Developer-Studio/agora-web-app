...
const biasRatings = [
  { label: "Leva", color: "bg-bias-left", textColor: "text-white" },
  {
    label: "C. Leva",
    color: "bg-bias-center-left",
    textColor: "text-black",
  },
  { label: "Center", color: "bg-bias-center", textColor: "text-black" },
  {
    label: "C. Desna",
    color: "bg-bias-center-right",
    textColor: "text-black",
  },
  { label: "Desna", color: "bg-bias-right", textColor: "text-white" },
];
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription
            render={<div />}
            className="text-primary/70 text-start text-sm"
          >
